...
def add_aircraft():
    if request.method == 'POST':
        ...
        capacity = request.form['Capacity']  # Add capacity
        ...
        # Check if manufacturer or model exceeds 100 characters
        ...
        try:
            ...
            database.add_aircraft(aircraft_id, icao_code, registration, manufacturer, model, capacity)  # Add capacity
...
def update_aircraft(aircraft_id):
    ...
    if request.method == 'POST':
        ...
        capacity = request.form.get('Capacity', '').strip()  # New capacity field
        ...
        try:
            database.update_aircraft(aircraft_id, icao_code, registration, manufacturer, model, capacity)
